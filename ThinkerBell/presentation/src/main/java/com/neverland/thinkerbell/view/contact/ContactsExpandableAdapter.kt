...
class ContactsExpandableAdapter(private val groups: List<Group<DeptContact>>) :
    ...
    inner class SubgroupViewHolder(private val binding: ItemSubGroupBinding) :
        ...
        fun bind(subgroup: SubGroup<DeptContact>) {
            ...
            if (subgroup.isExpanded) {
                binding.clSubGroup.setBackgroundColor(
    ...
    inner class ItemViewHolder(private val binding: ItemContactBinding) :
        RecyclerView.ViewHolder(binding.root) {
