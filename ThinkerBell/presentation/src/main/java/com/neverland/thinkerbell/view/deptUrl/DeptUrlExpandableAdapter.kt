...
class DeptUrlExpandableAdapter(private val groups: List<Group<DeptUrl>>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            TYPE_ITEM -> {
                val binding =
                    ItemDeptUrlBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ItemViewHolder(private val binding: ItemDeptUrlBinding) :
        RecyclerView.ViewHolder(binding.root) {
